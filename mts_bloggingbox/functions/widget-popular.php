	...
	class mts_popular_posts_widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( __('%sPopular Posts', 'bloggingbox' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
				array( 'description' => __( 'Displays most Popular Posts with Thumbnail.', 'bloggingbox' ) )
			);
		}
	 	...
	 	public function form( $instance ) {
			...
			$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Popular Posts', 'bloggingbox' );
			...
			<p>
			   <label for="<?php echo $this->get_field_id( 'days' ); ?>"><?php _e( 'Popular limit (days):', 'bloggingbox' ); ?>
