	...
	class single_category_posts_widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( __('%sCategory Posts', 'bloggingbox' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
				array( 'description' => __( 'Display the most recent posts from a single category', 'bloggingbox' ) )
			);
		}
	 	...
	 	public function form( $instance ) {
			...
			$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Featured Category', 'bloggingbox' );
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'cat' ); ?>"><?php _e( 'Category:', 'bloggingbox' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'qty' ); ?>"><?php _e( 'Number of Posts to show', 'bloggingbox' ); ?></label>
			...
			<p>
			   <label for="<?php echo $this->get_field_id( 'title_length' ); ?>"><?php _e( 'Title Length:', 'bloggingbox' ); ?>
			...
			<p>
				<label for="<?php echo $this->get_field_id("show_thumb1"); ?>">
					...
					<?php _e( 'Show Thumbnails', 'bloggingbox' ); ?>
				</label>
			</p>
			
			<p>
				<label for="<?php echo $this->get_field_id('box_layout'); ?>"><?php _e('Posts layout:', 'bloggingbox' ); ?></label>
				<select id="<?php echo $this->get_field_id('box_layout'); ?>" name="<?php echo $this->get_field_name('box_layout'); ?>">
					<option value="horizontal-small" <?php selected($box_layout, 'horizontal-small', true); ?>><?php _e('Horizontal', 'bloggingbox' ); ?></option>
					<option value="vertical-small" <?php selected($box_layout, 'vertical-small', true); ?>><?php _e('Vertical', 'bloggingbox' ); ?></option>
				</select>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id("date"); ?>">
					...
					<?php _e( 'Show post date', 'bloggingbox' ); ?>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id("comment_num"); ?>">
					...
					<?php _e( 'Show number of comments', 'bloggingbox' ); ?>
				</label>
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id("show_excerpt"); ?>">
					...
					<?php _e( 'Show excerpt', 'bloggingbox' ); ?>
				</label>
			</p>
			
			<p>
			   <label for="<?php echo $this->get_field_id( 'excerpt_length' ); ?>"><?php _e( 'Excerpt Length:', 'bloggingbox' ); ?>
					...
					<div class="post-img">
						<a href="<?php echo esc_url( get_the_permalink() ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>">
							<?php if ( has_post_thumbnail() ) { ?>
								<?php the_post_thumbnail( 'bloggingbox-' . $thumbnail, array( 'title' => '' ) ); ?>
							<?php } else { ?>
								<img class="wp-post-image" src="<?php echo get_template_directory_uri() . '/images/nothumb-bloggingbox-' . $thumbnail . '.png'; ?>" alt="<?php echo esc_attr( get_the_title() ); ?>"/>
							<?php } ?>
						</a>
					</div>
					<?php endif; ?>
					<div class="post-data">
						<div class="post-data-container">
							...
							<div class="post-info">
								...
								<span class="thecomment"><i class="fa fa-comment"></i> <?php echo comments_number('0','1','%');?></span>
								<?php endif; ?>
							</div><!--.post-info-->
							<?php endif; ?>
