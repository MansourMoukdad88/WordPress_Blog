...
function rank_math_admin_notice() {
	...
	if ( ! $rm_installed ) {
		$action  = __( 'Install for FREE', 'bloggingbox' );
		...
		$action  = __( 'Activate it now', 'bloggingbox' );
	...
	<div class="notice rm-notice welcome-panel plugin-card-seo-by-rank-math" id="try-rankmath-panel" style="clear:both;">
		<div class="welcome-panel-content" style="overflow:hidden;">
			...
			<div style="position: relative;">
				<h2><?php printf( __( 'Rank Math SEO plugin is recommended with %s theme!', 'bloggingbox' ), '<strong>' . esc_attr( $theme_name ) . '</strong>' ); ?></h2>
				<p class="about-description"><?php esc_html_e( 'The NEW Rank Math SEO plugin offers amazing features to help you write better content and get traffic from the search engines.', 'bloggingbox' ); ?></p>
				<ul>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Search Console Integration', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Keyword Ranking', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Keyword Suggession', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( '15+ Rich Snippets aka Schema Types', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Advanced SEO Analysis Tool', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Automated Image SEO', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'XML Sitemap', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( '404 Monitor', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Redirection Manager', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Local SEO Optimization', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Lightweight', 'bloggingbox' ); ?>
					</li>
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'and much more...', 'bloggingbox' ); ?>
					</li>
				</ul>
			...
			<a class="welcome-panel-close" id="wp_try_rankmath_panel-hide" href="<?php echo add_query_arg( 'rank_math_admin_notice_ignore', '1' ); ?>" aria-label="<?php esc_attr_e( 'Dismiss the Rank Math panel', 'bloggingbox' ); ?>"><?php esc_html_e( 'Dismiss', 'bloggingbox' ); ?></a>
		...
		<script type="text/javascript">
			jQuery(document).ready( function($) {
				...
				installRankmathSuccess = function( response ) {
					...
					tryRankmathPanel.find('.install-now').text('<?php echo esc_js( __( 'Activating...', 'bloggingbox' ) ); ?>');
